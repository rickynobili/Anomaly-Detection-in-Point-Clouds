...
pc = pcread('big_damaged_wall2.ply');
...
stepsize = 8;                       % size of the step when considering the points in the point cloud

global K;
K=80;                                  % KNN

MOD=3;                              % useful to print which points have been analysed
...
gammaICI=1.5;                     % ICI Gamma threshold
